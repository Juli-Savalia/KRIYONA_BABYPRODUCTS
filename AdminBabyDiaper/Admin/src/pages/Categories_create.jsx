      ...
      <section className='product_create pt-10 pb-20'>
        <div className="container">
          <button className='rounded-md bg-indigo-500 w-40 h-12 mb-4'>
            <Link className='text-white text-decoration-none text-md' to={'/create_brands'}>+ Create Brand</Link>
          </button>
            <div className="flex flex-wrap items-center">
                <div className="col-12 bg-white p-3 rounded-md">
                    <h3 className='font-semibold text-2xl'>Create Category</h3>
                    <form type='submit' className="py-4 flex flex-wrap items-center justify-center">
                        ...
                        <div className="px-2 col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            ...
                            <input type="text" placeholder='Add Category' className='text-xs block my-3 w-100  p-3 background_color rounded-md outline-none' required/>
                            </div>
                        </div>
                        <div className="px-2 col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <div className='w-100'>
                            <label className='text-sm'>Category Icon</label>
                        ...
                        <div className="px-2 col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <div className='w-100'>
                            <label className='text-sm'>Category Logo (use small logo .png file)</label>
...
export default Categories_create
